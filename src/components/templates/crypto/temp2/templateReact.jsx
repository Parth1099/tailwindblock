      ...
      <div className="md:max-w-[690px] px-[15px] md:px-0 capitalize sm:max-w-[590px] xl:max-w-[1050px] lg:max-w-[900px] flex flex-col items-center gap-10 md:gap-[80px] lg:gap-[100px]">
        <div className=" w-full flex flex-col sm:flex-row justify-between gap-[30px]   ">
          <div className="flex flex-col  gap-[20px] md:gap-[30px] md:max-w-[330px]  lg:max-w-[510px] text-white text-start">
            ...
            <div className="text-start  -mt-[10px] text-[16px] md:text-[16px]   leading-[22px] md:leading-[22px]  font-normal">
                ...
                {discover.map((data, index) => {
                  return (
                    <div key={index} className="max-w-[150px] w-full">
                      ...
                      <div className="text-[16px] md:text-[16px] lg:text-[24px] font-normal leading-[38px]">
                        {data.field}
                      </div>
                    </div>
                  );
        ...
        <div className=" md:px-0 text-white flex flex-col gap-10  lg:gap-[60px] w-full ">
          <div className="pl-[7%] sm:pl-0 flex flex-col items-start gap-[10px] justify-start text-start">
            <div className="text-[28px] lg:text-[38px] leading-[39px] lg:leading-[45px] font-semibold">
              Trending Collection
            </div>
            <div className="flex justify-between">
              <div className="text-[16px] md:text-[22px] md:leading-[22px] lg:leading-[35px] font-normal">
                Checkout our weekly updated trending collection.
              </div>
            </div>
          </div>
          <div className="flex justify-center   gap-[30px]">
            {trending.map((data, i, index) => {
              return (
                <div
                  key={index}
                ...
                >
                  <div>
                    <img src={data.img1} alt="" className="w-full" />
                  </div>
                  <div className="w-full justify-between sm:flex-row flex gap-[15px]">
                    <div>
                      <img src={data.img2} alt="" className="w-full" />
                    </div>
                    <div>
                      <img src={data.img3} alt="" />
                    </div>
                    <div className="w-full max-w-[100px] max-h-[100px] flex justify-center items-center bg-[#A259FF]  rounded-[20px] text-[16px] lg:text-[22px] font-bold leading-[35px] ">
                      1025+
                    </div>
                  </div>
        ...
        <div className=" sm:mt-0 text-white  flex flex-col justify-center gap-10 sm:gap-[60px] max-w-[690px] md:max-w-[800px]  xl:max-w-[1050px]  lg:max-w-[900px]  w-full ">
          <div className=" sm:px-0 flex justify-between text-start">
            <div className="flex flex-col gap-[10px] px-[30px] sm:px-0  sm:max-w-[343px] lg:max-w-full">
              <div className="text-[28px] lg:text-[38px] leading-[39px]  lg:leading-[45px] font-semibold">
                Top creators
              </div>
              <div className="text-[16px] lg:text-[22px] leading-[22px] lg:leading-[35px] font-normal">
          ...
          <div className="flex flex-wrap gap-[20px]  sm:gap-[30px] justify-center w-full ">
            {creator.map((data, i, index) => {
              return (
                <div
                  key={index}
                  className={`w-full relative   md:max-w-[330px]  lg:max-w-[200px] xl:max-w-[240px] h-[100px] lg:h-[239px] bg-[#3B3B3B] rounded-[20px] flex lg:flex-col gap-[20px] justify-center items-center ${
                    i > 5 && "hidden lg:flex"
                  }`}
                >
        ...
        <div className="mt-10 sm:mt-0 text-white flex flex-col justify-center gap-10 sm:gap-[30px] lg:gap-[60px]   w-full ">
          <div className="pl-[8%] sm:pl-0 flex justify-start lg:justify-start ">
            ...
            {browse.map((data, index) => {
              return (
                ...
                >
                  ...
                  <div className="lg:pl-[30px] whitespace-nowrap h-[67px] lg:h-[76px] text-[16px] sm:text-[12px] md:text-[16px] lg:text-[22px] leading-[20px] font-semibold text-start px-5 sm:px-[10px] pt-[30px] rounded-b-[20px] bg-[#3B3B3B]">
                    {data.title}
                  </div>
                </div>
              );
        ...
        <div className="mt-10 sm:mt-0 text-white  flex flex-col justify-center gap-10 lg:gap-[60px] w-full ">
          <div className=" flex justify-between text-start">
            <div className="pl-[8%] sm:pl-0 flex flex-col gap-[10px]">
              <div className="text-[28px] lg:text-[38px] leading-[39px] lg:leading-[45px] font-semibold">
                Discover More NFTs
              </div>
              <div className="text-[16px] lg:text-[22px] leading-[22px] lg:leading-[35px] font-normal">
                    ...
                    <div className="flex flex-col justify-center items-center gap-[25px] ">
                      <div className="text-start flex flex-col gap-[10px]  max-w-[270px] w-full ">
                        ...
                        <div className="flex gap-[12px] items-center">
                          ...
                          <div className="!font-spacemono text-[16px] font-normal leading-[22px]">
                            {data.title2}
                          </div>
                        </div>
                      </div>
                      <div className="!font-spacemono flex justify-between  max-w-[270px] w-full">
                        <div className="flex flex-col gap-[8px]">
                          <div className="text-start text-[12px] text-[#858584] font-normal leading-[13px]">
                            Price
                          </div>
                          <div className="text-[16px] text-white font-normal leading-[21px]">
                            1.63 ETH
                          </div>
                        </div>
                        <div className="flex flex-col gap-[8px]">
                          <div className="text-[12px] text-[#858584] font-normal leading-[13px]">
                            Highest Bid
                          </div>
                          <div className="text-[16px] text-white font-normal leading-[21px]">
                            0.33 wETH
        ...
        <div className="-bottom-[25%] sm:-bottom-[10%] left-1/2 -translate-x-1/2 -translate-y-1/2  absolute md:flex-row flex-col flex gap-[30px] sm:gap-[80px]  ">
          <div className="flex flex-col gap-[30px]">
            <div className="flex justify-center items-center text-white gap-[10px] max-w-[151px] py-[10px] bg-[#3B3B3B] rounded-[20px]">
              <img src={"/assets/crypto/mushroom4.png"} alt="" />
              ...
              <div className="max-w-[235px]  flex flex-col gap-[10px]">
                ...
                <div className="flex gap-[10px]">
                  <div className="flex flex-col gap-[5px]">
                    ...
                    <div className="text-start text-[12px] leading-[12px] font-normal">
                      Hours
                    </div>
                  </div>
      ...
      <div className="md:max-w-[690px] capitalize sm:max-w-[590px] w-full   xl:max-w-[1050px] lg:max-w-[900px] flex flex-col items-center gap-10 md:gap-[80px] lg:gap-[100px]">
        <div className="text-white px-[15px] md:px-0 flex flex-col  justify-center gap-10 lg:gap-[60px]  w-full ">
          <div className=" sm:pl-0 flex flex-col lg:gap-[10px] justify-start text-start">
            ...
            <div className="text-[16px] lg:text-[22px] leading-[35px] font-normal">
          ...
          <div className="flex flex-col justify-center items-center sm:flex-row gap-[30px] w-full max-w-[1050px]">
            {howwoks.map((data, index) => {
              return (
                <div
                  key={index}
                  className=" md:max-w-[330px] w-full p-[20px] sm:p-0   max-h-fit sm:h-[337px] lg:h-[439px] bg-[#3B3B3B] rounded-[20px] flex sm:flex-col gap-[20px]    sm:justify-center items-center"
                >
                  <div>
                    <img
                      src={data.img}
                  ...
                  <div className="text-start sm:text-center max-w-[155px] md:max-w-[170px] lg:max-w-[270px] w-full flex flex-col gap-[10px]">
                    <div className="text-[16px] lg:text-[22px] leading-[30px] font-semibold">
                      {data.title}
                    </div>
                    <div className="normal-case text-[12px] lg:text-[16px] leading-[16px] lg:leading-[22px] font-normal">
                      {data.desc}
                    </div>
                  </div>
                </div>
        ...
        <div className="px-[15px] lg:px-[10px] md:px-[20px] xl:px-0 w-full sm:bg-[#3B3B3B] rounded-[20px]  sm:h-[360px]  lg:h-[430px] flex flex-col sm:flex-row gap-[30px] lg:gap-[40px] xl:gap-[80px] items-center justify-center">
          ...
          <div className="max-w-[300px] md:max-w-[375px] lg:max-w-[425px] w-full text-start text-white flex flex-col gap-[20px] lg:gap-10 ">
            <div className="flex flex-col gap-[10px]">
              <div className="text-[28px] lg:text-[38px] font-semibold leading-[45px]">
                Join our weekly digest
              </div>
              <div className="text-[16px] lg:text-[22px] font-normal  leading-[22px] lg:leading-[35px]">
        ...
        <div className="max-w-[315px] sm:max-w-[690px] md:max-w-[900px] xl:max-w-[1050px] md:px-[20px]  w-full">
          <div className="flex flex-col gap-[30px] pt-[40px] md:flex-row md:justify-between ">
            <div className="text-[#CCCCCC] flex flex-col gap-[25px]">
              <div>
                <img src={"/assets/crypto/logo.svg"} alt="" />
              </div>
              <div className="flex flex-col gap-[20px]">
                ...
                <div className="flex flex-col gap-[15px]">
                  ...
                  <div className="flex gap-[12px]">
                    <img src={"/public/assets/crypto/discord.svg"} alt="" />
                    <img src={"/public/assets/crypto/youtube.svg"} alt="" />
                    <img src={"/public/assets/crypto/twitter.svg"} alt="" />
                    <img src={"/public/assets/crypto/instagram.svg"} alt="" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="md:max-w-[420px] w-full flex flex-col lg gap-[25px] ">
              ...
              <div className="flex flex-col gap-[20px] text-[16px] font-normal leading-[22px] text-[#CCCCCC]">
                ...
                <div className="hidden sm:flex max-w-[420px] w-full  bg-white rounded-[20px]   items-center justify-between">
                  <div className="text-black pl-[20px] text-[12px] lg:text-[16px] font-normal leading-[22px] ">
                    Enter your email here
                  </div>
                  <div className="px-[50px] text-white py-[12px] lg:py-[17px] text-[16px] font-semibold leading-[22px] rounded-[20px]  bg-[#A259FF]">
                    <button className=" ">Subscribe</button>
                  </div>
                </div>

                <div className="sm:hidden flex flex-col gap-[16px]">
                  <div className="max-w-[300px] text-[16px] w-full bg-white border py-[12px] rounded-[20px] text-black border-[#A259FF]">
                    <button className="px-5">Enter Your Email Address</button>
                  </div>
                  <div className="max-w-[300px] py-[12px] text-[16px] font-semibold leading-[22px] rounded-[20px]  bg-[#A259FF] flex justify-center items-center gap-[15px]">
                    <img src={"/assets/crypto/email.svg"} alt="" />
