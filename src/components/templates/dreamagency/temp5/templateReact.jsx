...
function DreamAgency() {
  ...
  const cardDetail = [
    ...
    },
    {
      ...
      logoBg: "bg-[#FFEED4]",
      logo: "/assets/dreamagency/mobileLogo.svg",
    },
    {
      title: "Marketing",
      logoBg: "bg-[#FFD4D4]",
  ...
  const templateCard = [
    {
      title: "3D NFT",
      img: "/bgcomponents/bgnft.png",
    },
    {
      title: "Crypto",
      img: "/bgcomponents/bgcrypto.png",
    },
    {
      title: "Advocate",
      img: "/bgcomponents/bgadvocate.png",
    },
    {
      title: "TBDesign",
      img: "/bgcomponents/bgtbdesign.png",
    },
  ];
        ...
        <div className="mx-auto max-w-screen-2xl">
          <div className="px-5 flex flex-col md:flex-row md:justify-between items-center relative sm:pl-[50px] mt-10 lg:mt-20 gap-7 md:gap-0 md:mb-4 mb-8">
            ...
            <div className="relative z-10">
              <img
                src={"/assets/dreamagency/home.svg"}
                alt="home"
          ...
          <div className="flex justify-between items-center w-full px-5 sm:px-[50px] flex-col-reverse md:flex-row mt-11 sm:mt-0">
            <div className="relative">
              <img
                src="/assets/dreamagency/aboutUs.svg"
                className="md:h-full sm:h-[462px] h-[278px]"
              />
            </div>
          ...
          <div className="w-full relative h-[725px] md:h-[636px] py-24 overflow-hidden mt-12">
        ...
        <div className="bg-black rounded-tr-[158px]  relative pt-[66px] mt-[92px] w-full">
          <div className="w-full flex md:gap-4 gap-8 sm:justify-between flex-col md:flex-row max-w-screen-2xl mx-auto  pb-[76px] sm:pl-12 sm:pr-12 px-5 lg:pr-[152px]">
            <div className="flex flex-col gap-4 justify-start">
              <h1 className="text-4xl text-white font-playFairDisplay tracking-[0.01]">
                Dream Agency
              </h1>
              ...
              <div className="flex">
                <input
                  type="email"
                  name="email"
                  className="bg-transparent p-3 border border-white text-white"
            ...
            <div className="relative">
              <div className="max-w-[197px] w-full flex flex-col justify-start px-2.5 py-[7px] bg-white shadow-4xl absolute top-[26px] left-8">
                ...
                <p className="font-normal text-[#51A0DC] text-sm leading-[159.8%]">
                  View Larger Map
                </p>
              </div>
