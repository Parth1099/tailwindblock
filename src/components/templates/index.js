                      ...
                      >
                        ...
                        <div className=" hidden lg:flex align-middle gap-2 items-center">
                          ...
                          >
                            <MobileViewLogo
                              fill={
                                componentWidth === "425px" ? "blue" : "black"
                              }
                            />
                          </div>
                          <div
                          ...
                          >
                            <TabletViewLogo
                              fill={
                                componentWidth === "768px" ? "blue" : "black"
                              }
                            />
                          </div>
                          <div
          ...
          <div className="container grid lg:grid-cols-4 grid-cols-1 gap-7">
            {TemplateConstant?.map((data, index) => {
              ...
              return data.slug !== query.templates ? (
                <Link key={index} href={`/templates/${data.type}/${data.slug}`}>
            ...
            {targetsLength < 4 &&
              COMPONENT_LIST.slice(0, 4 - targetsLength).map((data, index) => {
                return (
                  <Link
                    key={index}
                    href={`/components/${data.type}/${data.slug}`}
