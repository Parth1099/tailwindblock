          ...
          <div className="flex flex-col">
            ...
            >
              <div className="flex justify-between leading-[14px] items-center">
                ...
                <img
                  src={"/assets/creditcard/sample1/mc_symbol.svg"}
              ...
              <div className="flex">
                <span className="flex items-center text-base top-3">
                  <img
                    src="/assets/creditcard/sample1/left-caret.svg"
                    alt="not found"
              ...
              <div className="flex justify-between text-[13px] font-bold text-gradient-to-r from-black to-gray-200">
                <span>
                  <input
                    className="bg-transparent focus:outline-none focus:border border-black rounded-md px-1"
                    type="text"
...
export let currentMonth = ("0" + (new Date().getMonth() + 1)).slice(-2);
