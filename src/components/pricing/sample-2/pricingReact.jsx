  ...
  return (
    <>
      <div className="relative">
        ...
        <container className="bg-gray-300 lg:bg-transparent flex flex-col top-0 w-full absolute lg:flex-row justify-center items-center lg:h-screen gap-6 lg:px-5 xl:px-0 py-8 lg:py-0">
          <div
