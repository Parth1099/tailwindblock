      ...
      <div className="flex gap-5 px-3 lg:px-9 py-4 lg:py-4 bg-[#F1F5FD] overflow-x-auto overflow-y-hidden border-b-2 border-b-borderColor">
        <div className="flex items-center gap-3 md:gap-5 w-full justify-between">
          <div className="flex items-center lg:gap-7 ">
            <div className="flex gap-3 md:gap-5 items-center">
              ...
              <div className="group flex relative my-auto mr-4 lg:mr-0">
                ...
                <span className="absolute bottom-7 right-[-10px] scale-0 transition-all rounded bg-gray-800 p-1 text-xs text-white group-hover:scale-100">
                  Screen
                </span>
              </div>
            </div>
            ...
            {component?.isCustomizeColor && (
              <>
                <div className={openPicker && "z-40"} ref={pickerRef}>
                  <div
                    className="px-1.5 md:px-3 py-2 md:py-3 text-lg  border-2 rounded-md border-borderColor cursor-pointer items-center flex text-[#00000061] gap-2 "
          ...
          <div className="flex items-center justify-end gap-4 md:gap-5">
            ...
            <div ref={languageRef}>
              <div
                className="px-1.5 lg:px-3 text-lg py-0.5 lg:py-3 border-2 rounded-md border-borderColor cursor-pointer items-center flex text-[#00000061] w-20 md:w-24 justify-between"
