    ...
    <div className=" flex text-[#ECDBBA] flex-col items-center w-full overflow-x-hidden ">
      <div className="bg-[#ECDBBA] gap-[43px]  pb-10  flex flex-col items-center  justify-center max-h-fit lg:h-[780px] w-full">
        ...
        <div className=" md:flex items-center justify-between max-w-[1180px] w-full">
          <div className="text-start flex flex-col gap-2.5 md:gap-5 px-[4%] xl:px-0 md:max-w-[430px] lg:max-w-[518px] w-full ">
            <div className="text-[#2D4263] font-Cormorant text-[25px] md:text-[50px] lg:text-[75px] md:leading-[70px] lg:leading-[87px] font-medium tracking-[0.03em]">
              Discover{" "}
            ...
            <div className="text-[#2D4263] text-[14px] font-montserrat">
              ...
              <div className="w-full justify-between flex gap-2.5 md:gap-[30px] lg:gap-[50px] ">
                {discover.map((data, index) => {
                  return (
                    ...
                    >
                      <div className="text-xl md:text-[32px] font-semibold leading-[36px]">
                        {data.price}
                      </div>
                      <div className="text-[10px] whitespace-nowrap md:text-base font-normal tracking-[0.03em]">
                        {data.field}
                      </div>
                    </div>
                  );
            ...
            <div className=" w-full lg:max-w-[150px] text-center text-[#2D4263] px-7 py-3 border-2 border-[#2D4263] rounded-[68px]">
          ...
          <div className="max-w-[1180px] flex flex-col gap-[50px]  lg:gap-[123px]">
            <div className="mt-[30px] md:mt-[93px] flex flex-col gap-[50px] max-w-[1180px]  justify-center w-full">
              <div className=" flex justify-between items-center">
                ...
                <div className="text-[12px] text-center px-[30px] md:max-w-[166px] md:w-full py-3  border-2 border-[#ECDBBA] rounded-[68px]">
        ...
        <div className="px-[4%] w-full">
          <div className="mb-[70px] flex gap-[36px]  flex-col justify-center items-center w-full bg-[#C84B31] max-h-fit py-[3%] rounded-[24px]">
            <div className="flex flex-col text-center items-center gap-[15px]">
              ...
              <div className="font-montserrat tracking-[0.03em] text-[15px] md:text-xl leading-[24px] font-normal">
                Meet the company team, artist and collector for platform
                updates, announcements, and more ...
              </div>
            </div>
            <div className="max-w-[252px] text-lg w-full bg-[#2D4263]  py-3 md:py-3 flex gap-2.5 justify-center items-center rounded-[68px]">
      ...
      <div className=" bg-[#191919] w-full flex justify-center pb-[30px] flex-col items-center gap-[50px]">
        ...
        <div className="px-[5%] lg:px-0   flex-col flex gap-[20px]  md:flex-row  md:gap-[20px]  md:flex items-start justify-between max-w-[1180px] w-full">
          <div className="text-start -mt-[25px] max-w-[464px] w-full flex flex-col  gap-[11px] ">
            <div className="text-[64px] leading-[78px] font-extrabold font-montserrat ">
              ED
            </div>
          ...
          <div className="items-start  flex  flex-col gap-2 md:gap-[21px]">
            ...
            <div className="font-montserrat text-[16px] leading-[20px] tracking-[0.03em] flex flex-col gap-2.5 font-medium">
              <div className="border whitespace-nowrap flex justify-center items-center gap-2.5 px-[24px] border-[#ECDBBA] max-w-[221px] py-[8px] rounded-[68px]">
                Get NFT updates
